...
public class AnimationPlanner extends AbstractPlanner<TimedAnimationUnit>
{
    ...
    private TimedAnimationUnit createTAU(BMLBlockPeg bbPeg, Behaviour b) throws BehaviourPlanningException
    {
        ...
        else if (b instanceof BMLTProcAnimationBehaviour && ((BMLTProcAnimationBehaviour) b).getName() == null &&
                (((BMLTProcAnimationBehaviour) b).hasContent() || ((BMLTProcAnimationBehaviour) b).getFileName() != null))
        {
