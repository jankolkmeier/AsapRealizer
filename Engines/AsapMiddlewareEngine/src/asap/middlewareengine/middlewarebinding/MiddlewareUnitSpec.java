...
/**
 */
public class MiddlewareUnitSpec extends XMLStructureAdapter
{
    public MiddlewareUnit middlewareUnit;
    private String type;
    ...
    public void decodeContent(XMLTokenizer tokenizer) throws IOException
    {
        while (tokenizer.atSTag())
        {
            ...
            else if (tag.equals(MiddlewareUnitAssembler.xmlTag()))
            {
                MiddlewareUnitAssembler nua = new MiddlewareUnitAssembler();
                nua.readXML(tokenizer);
                middlewareUnit = nua.getMiddlewareUnit();
            }
        }
    }
     ...
     */
    private static final String XMLTAG = "MiddlewareUnitSpec";
